...
// Resend's test sender (onboarding@resend.dev) can only deliver to the Resend account owner.
// Until a real domain is verified, verification emails won't reach users.
function canSendToAnyone() {
    const from = process.env.EMAIL_FROM || '';
    // Test sender can't deliver to arbitrary addresses
